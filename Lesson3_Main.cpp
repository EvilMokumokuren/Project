...
int main()
{
	...
	*pArr = 27; // [2][2][2]
	...
	// Сделала не константами переменные, т.к. формулировка двояка в п.4 и можно понять, что переменные <> константе. Что лучше почитать, чтобы понять, как константы из другого файла смотреть? В гугле у меня не очень вышло найти, а интересно
